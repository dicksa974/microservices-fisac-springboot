package com.egokia.venue.controller;

import com.egokia.venue.controller.service.VenueService;
import com.egokia.venue.db.domain.Venue;
import com.egokia.venue.model.Response;
...
public class VenueController {
    ...
    @ApiOperation(
            value = "Find all venue records for auth given page and size",
    ...
    @ApiOperation(
            value = "Find all venue records for auth given Reservation Id",
            notes = "Find all venue records for auth given Reservation Id",
