package com.egokia.actuator;

import com.egokia.reservation.db.domain.Reservation;
import com.egokia.reservation.db.repository.ReservationRepository;
...
/**
 * The ReservationHealthIndicator is auth custom Spring Boot Actuator HealthIndicator
 ...
 * portion of the application's health, returing auth Health object which indicates
