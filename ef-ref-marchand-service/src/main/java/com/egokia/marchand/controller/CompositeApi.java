...
public class CompositeApi {
    ...
    @ApiOperation(
            value = "Find all booking records for auth given Reservation Id",
            notes = "Find all booking records for auth given Reservation Id",
    ...
    public BookingDetail bookingsAll(@RequestParam("id") long id,
